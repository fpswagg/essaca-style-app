...
import ExampleSection from '@/components/classical-symmetry/basic/ExampleSection';
import LoginFormsSection from '@/components/classical-symmetry/basic/LoginFormsSection';
import AdminDashboardSection from '@/components/classical-symmetry/basic/AdminDashboardSection';
import ClientDashboardSection from '@/components/classical-symmetry/basic/ClientDashboardSection';
import StaffDashboardSection from '@/components/classical-symmetry/basic/StaffDashboardSection';
import ApplicationFormsSection from '@/components/classical-symmetry/basic/ApplicationFormsSection';
import AllDialogsSection from '@/components/classical-symmetry/basic/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/classical-symmetry/basic/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/classical-symmetry/basic/ManagementPagesOverviewSection';
...
export default function ClassicalsymmetryBasicPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Classical Symmetry</span> - Basic
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with classical-symmetry / basic substyle
          </p>
        </div>
