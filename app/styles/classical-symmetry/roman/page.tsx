...
import ExampleSection from '@/components/classical-symmetry/roman/ExampleSection';
import LoginFormsSection from '@/components/classical-symmetry/roman/LoginFormsSection';
import AdminDashboardSection from '@/components/classical-symmetry/roman/AdminDashboardSection';
import ClientDashboardSection from '@/components/classical-symmetry/roman/ClientDashboardSection';
import StaffDashboardSection from '@/components/classical-symmetry/roman/StaffDashboardSection';
import ApplicationFormsSection from '@/components/classical-symmetry/roman/ApplicationFormsSection';
import AllDialogsSection from '@/components/classical-symmetry/roman/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/classical-symmetry/roman/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/classical-symmetry/roman/ManagementPagesOverviewSection';
...
export default function ClassicalsymmetryRomanPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Classical Symmetry</span> - Roman
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with classical-symmetry / roman substyle
          </p>
        </div>
