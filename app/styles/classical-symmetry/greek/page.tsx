...
import ExampleSection from '@/components/classical-symmetry/greek/ExampleSection';
import LoginFormsSection from '@/components/classical-symmetry/greek/LoginFormsSection';
import AdminDashboardSection from '@/components/classical-symmetry/greek/AdminDashboardSection';
import ClientDashboardSection from '@/components/classical-symmetry/greek/ClientDashboardSection';
import StaffDashboardSection from '@/components/classical-symmetry/greek/StaffDashboardSection';
import ApplicationFormsSection from '@/components/classical-symmetry/greek/ApplicationFormsSection';
import AllDialogsSection from '@/components/classical-symmetry/greek/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/classical-symmetry/greek/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/classical-symmetry/greek/ManagementPagesOverviewSection';
...
export default function ClassicalsymmetryGreekPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Classical Symmetry</span> - Greek
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with classical-symmetry / greek substyle
          </p>
        </div>
