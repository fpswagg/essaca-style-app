...
import ExampleSection from '@/components/basic-style/crisp/ExampleSection';
import LoginFormsSection from '@/components/basic-style/crisp/LoginFormsSection';
import AdminDashboardSection from '@/components/basic-style/crisp/AdminDashboardSection';
import ClientDashboardSection from '@/components/basic-style/crisp/ClientDashboardSection';
import StaffDashboardSection from '@/components/basic-style/crisp/StaffDashboardSection';
import ApplicationFormsSection from '@/components/basic-style/crisp/ApplicationFormsSection';
import AllDialogsSection from '@/components/basic-style/crisp/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/basic-style/crisp/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/basic-style/crisp/ManagementPagesOverviewSection';
...
export default function BasicstyleCrispPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Basic Style</span> - Crisp
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with basic-style / crisp substyle
          </p>
        </div>
