import '@/app/styles/basic-style.css';
import { Poppins } from 'next/font/google';
import ExampleSection from '@/components/basic-style/elegant/ExampleSection';
import LoginFormsSection from '@/components/basic-style/elegant/LoginFormsSection';
import AdminDashboardSection from '@/components/basic-style/elegant/AdminDashboardSection';
import ClientDashboardSection from '@/components/basic-style/elegant/ClientDashboardSection';
import StaffDashboardSection from '@/components/basic-style/elegant/StaffDashboardSection';
import ApplicationFormsSection from '@/components/basic-style/elegant/ApplicationFormsSection';
import AllDialogsSection from '@/components/basic-style/elegant/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/basic-style/elegant/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/basic-style/elegant/ManagementPagesOverviewSection';
...
export default function BasicstyleElegantPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Basic Style</span> - Elegant
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with basic-style / elegant substyle
          </p>
        </div>
