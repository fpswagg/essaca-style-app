...
import ExampleSection from '@/components/basic-style/basic/ExampleSection';
import LoginFormsSection from '@/components/basic-style/basic/LoginFormsSection';
import AdminDashboardSection from '@/components/basic-style/basic/AdminDashboardSection';
import ClientDashboardSection from '@/components/basic-style/basic/ClientDashboardSection';
import StaffDashboardSection from '@/components/basic-style/basic/StaffDashboardSection';
import ApplicationFormsSection from '@/components/basic-style/basic/ApplicationFormsSection';
import AllDialogsSection from '@/components/basic-style/basic/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/basic-style/basic/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/basic-style/basic/ManagementPagesOverviewSection';
...
export default function BasicstyleBasicPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Basic Style</span> - Basic
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with basic-style / basic substyle
          </p>
        </div>
