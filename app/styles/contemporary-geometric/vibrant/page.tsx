...
import ExampleSection from '@/components/contemporary-geometric/vibrant/ExampleSection';
import LoginFormsSection from '@/components/contemporary-geometric/vibrant/LoginFormsSection';
import AdminDashboardSection from '@/components/contemporary-geometric/vibrant/AdminDashboardSection';
import ClientDashboardSection from '@/components/contemporary-geometric/vibrant/ClientDashboardSection';
import StaffDashboardSection from '@/components/contemporary-geometric/vibrant/StaffDashboardSection';
import ApplicationFormsSection from '@/components/contemporary-geometric/vibrant/ApplicationFormsSection';
import AllDialogsSection from '@/components/contemporary-geometric/vibrant/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/contemporary-geometric/vibrant/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/contemporary-geometric/vibrant/ManagementPagesOverviewSection';
...
export default function ContemporarygeometricVibrantPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Contemporary Geometric</span> - Vibrant
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with contemporary-geometric / vibrant substyle
          </p>
        </div>
