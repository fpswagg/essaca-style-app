...
import ExampleSection from '@/components/urban-concrete/weathered/ExampleSection';
import LoginFormsSection from '@/components/urban-concrete/weathered/LoginFormsSection';
import AdminDashboardSection from '@/components/urban-concrete/weathered/AdminDashboardSection';
import ClientDashboardSection from '@/components/urban-concrete/weathered/ClientDashboardSection';
import StaffDashboardSection from '@/components/urban-concrete/weathered/StaffDashboardSection';
import ApplicationFormsSection from '@/components/urban-concrete/weathered/ApplicationFormsSection';
import AllDialogsSection from '@/components/urban-concrete/weathered/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/urban-concrete/weathered/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/urban-concrete/weathered/ManagementPagesOverviewSection';
...
export default function UrbanconcreteWeatheredPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Urban Concrete</span> - Weathered
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with urban-concrete / weathered substyle
          </p>
        </div>
