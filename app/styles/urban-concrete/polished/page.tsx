...
import ExampleSection from '@/components/urban-concrete/polished/ExampleSection';
import LoginFormsSection from '@/components/urban-concrete/polished/LoginFormsSection';
import AdminDashboardSection from '@/components/urban-concrete/polished/AdminDashboardSection';
import ClientDashboardSection from '@/components/urban-concrete/polished/ClientDashboardSection';
import StaffDashboardSection from '@/components/urban-concrete/polished/StaffDashboardSection';
import ApplicationFormsSection from '@/components/urban-concrete/polished/ApplicationFormsSection';
import AllDialogsSection from '@/components/urban-concrete/polished/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/urban-concrete/polished/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/urban-concrete/polished/ManagementPagesOverviewSection';
...
export default function UrbanconcretePolishedPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Urban Concrete</span> - Polished
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with urban-concrete / polished substyle
          </p>
        </div>
