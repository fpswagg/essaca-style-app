...
import ExampleSection from '@/components/urban-concrete/raw/ExampleSection';
import LoginFormsSection from '@/components/urban-concrete/raw/LoginFormsSection';
import AdminDashboardSection from '@/components/urban-concrete/raw/AdminDashboardSection';
import ClientDashboardSection from '@/components/urban-concrete/raw/ClientDashboardSection';
import StaffDashboardSection from '@/components/urban-concrete/raw/StaffDashboardSection';
import ApplicationFormsSection from '@/components/urban-concrete/raw/ApplicationFormsSection';
import AllDialogsSection from '@/components/urban-concrete/raw/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/urban-concrete/raw/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/urban-concrete/raw/ManagementPagesOverviewSection';
...
export default function UrbanconcreteRawPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Urban Concrete</span> - Raw
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with urban-concrete / raw substyle
          </p>
        </div>
