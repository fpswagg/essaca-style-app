...
import ExampleSection from '@/components/digital-tech/cyberpunk/ExampleSection';
import LoginFormsSection from '@/components/digital-tech/cyberpunk/LoginFormsSection';
import AdminDashboardSection from '@/components/digital-tech/cyberpunk/AdminDashboardSection';
import ClientDashboardSection from '@/components/digital-tech/cyberpunk/ClientDashboardSection';
import StaffDashboardSection from '@/components/digital-tech/cyberpunk/StaffDashboardSection';
import ApplicationFormsSection from '@/components/digital-tech/cyberpunk/ApplicationFormsSection';
import AllDialogsSection from '@/components/digital-tech/cyberpunk/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/digital-tech/cyberpunk/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/digital-tech/cyberpunk/ManagementPagesOverviewSection';
...
export default function DigitaltechCyberpunkPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Digital Tech</span> - Cyberpunk
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with digital-tech / cyberpunk substyle
          </p>
        </div>
