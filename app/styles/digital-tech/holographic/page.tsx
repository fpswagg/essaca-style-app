...
import ExampleSection from '@/components/digital-tech/holographic/ExampleSection';
import LoginFormsSection from '@/components/digital-tech/holographic/LoginFormsSection';
import AdminDashboardSection from '@/components/digital-tech/holographic/AdminDashboardSection';
import ClientDashboardSection from '@/components/digital-tech/holographic/ClientDashboardSection';
import StaffDashboardSection from '@/components/digital-tech/holographic/StaffDashboardSection';
import ApplicationFormsSection from '@/components/digital-tech/holographic/ApplicationFormsSection';
import AllDialogsSection from '@/components/digital-tech/holographic/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/digital-tech/holographic/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/digital-tech/holographic/ManagementPagesOverviewSection';
...
export default function DigitaltechHolographicPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Digital Tech</span> - Holographic
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with digital-tech / holographic substyle
          </p>
        </div>
