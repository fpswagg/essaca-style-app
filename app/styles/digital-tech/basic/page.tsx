...
import ExampleSection from '@/components/digital-tech/basic/ExampleSection';
import LoginFormsSection from '@/components/digital-tech/basic/LoginFormsSection';
import AdminDashboardSection from '@/components/digital-tech/basic/AdminDashboardSection';
import ClientDashboardSection from '@/components/digital-tech/basic/ClientDashboardSection';
import StaffDashboardSection from '@/components/digital-tech/basic/StaffDashboardSection';
import ApplicationFormsSection from '@/components/digital-tech/basic/ApplicationFormsSection';
import AllDialogsSection from '@/components/digital-tech/basic/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/digital-tech/basic/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/digital-tech/basic/ManagementPagesOverviewSection';
...
export default function DigitaltechBasicPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Digital Tech</span> - Basic
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with digital-tech / basic substyle
          </p>
        </div>
