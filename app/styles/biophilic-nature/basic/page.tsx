...
import ExampleSection from '@/components/biophilic-nature/basic/ExampleSection';
import LoginFormsSection from '@/components/biophilic-nature/basic/LoginFormsSection';
import AdminDashboardSection from '@/components/biophilic-nature/basic/AdminDashboardSection';
import ClientDashboardSection from '@/components/biophilic-nature/basic/ClientDashboardSection';
import StaffDashboardSection from '@/components/biophilic-nature/basic/StaffDashboardSection';
import ApplicationFormsSection from '@/components/biophilic-nature/basic/ApplicationFormsSection';
import AllDialogsSection from '@/components/biophilic-nature/basic/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/biophilic-nature/basic/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/biophilic-nature/basic/ManagementPagesOverviewSection';
...
export default function BiophilicnatureBasicPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Biophilic Nature</span> - Basic
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with biophilic-nature / basic substyle
          </p>
        </div>
