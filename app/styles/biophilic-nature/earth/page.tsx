...
import ExampleSection from '@/components/biophilic-nature/earth/ExampleSection';
import LoginFormsSection from '@/components/biophilic-nature/earth/LoginFormsSection';
import AdminDashboardSection from '@/components/biophilic-nature/earth/AdminDashboardSection';
import ClientDashboardSection from '@/components/biophilic-nature/earth/ClientDashboardSection';
import StaffDashboardSection from '@/components/biophilic-nature/earth/StaffDashboardSection';
import ApplicationFormsSection from '@/components/biophilic-nature/earth/ApplicationFormsSection';
import AllDialogsSection from '@/components/biophilic-nature/earth/AllDialogsSection';
import ApplicationDetailViewSection from '@/components/biophilic-nature/earth/ApplicationDetailViewSection';
import ManagementPagesOverviewSection from '@/components/biophilic-nature/earth/ManagementPagesOverviewSection';
...
export default function BiophilicnatureEarthPage() {
  return (
      ...
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16">
        <div className="text-center mb-12">
          <h1 className="text-display text-main mb-2">
            <span className="text-display-emphasis">Biophilic Nature</span> - Earth
          </h1>
          <p className="text-main/70 text-sm sm:text-base">
            All sections displayed with biophilic-nature / earth substyle
          </p>
        </div>
