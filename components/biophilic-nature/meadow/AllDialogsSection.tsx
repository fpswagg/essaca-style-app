...
export default function AllDialogsSection() {
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-cream border border-main/10 rounded-2xl shadow-sm">
        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button
              ...
              className="bg-page rounded-2xl p-4 border border-main/10 hover:border-olive/30 hover:shadow-md transition-all text-left"
            >
            ...
            <div className="relative bg-cream rounded-2xl shadow-xl max-w-md w-full p-6 border border-main/10 max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 bg-transparent border-2 bg-olive text-olive rounded-full px-6 py-2 font-medium hover:bg-olive hover:text-cream transition-colors"
                >
                  Cancel
                </button>
                <button
            ...
            <div className="relative bg-cream rounded-2xl shadow-xl max-w-md w-full p-6 border border-main/10 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 bg-olive text-cream rounded-full px-6 py-2 font-medium hover:bg-earth transition-colors"
                  >
                    Create Account
                  </button>
                </div>
