      ...
      <div className="flex flex-col gap-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
            {Object.entries(stats).map(([key, value]) => (
              <div key={key} className="bg-page rounded-lg p-4 border-2 border-main/30 text-center hover:border-olive/50 transition-colors shadow-md">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {managementLinks.map((link) => (
              <div
                key={link.name}
                className="bg-page rounded-lg p-4 border-2 border-main/30 hover:border-olive/50 hover:shadow-md transition-all cursor-pointer shadow-md"
              >
        ...
        <div>
          ...
          {applications.length === 0 ? (
            <div className="bg-page rounded-lg p-8 border-2 border-main/30 text-center shadow-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {applications.map((app) => (
                <div
                  key={app.id}
                  className="bg-page rounded-lg p-4 border-2 border-main/30 hover:border-olive/50 hover:shadow-md transition-all shadow-md"
                >
