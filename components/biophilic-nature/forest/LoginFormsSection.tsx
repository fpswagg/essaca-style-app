  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-cream border-2 border-main/30 rounded-lg shadow-md">
      <div className="flex flex-col gap-8">
        ...
        <div className="mt-4">
          <div className="max-w-md mx-auto bg-page rounded-lg p-6 border-2 border-main/30">
            {step === 'email' ? (
              <form onSubmit={handleEmailSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-olive text-cream rounded-full px-6 py-3 font-medium hover:bg-earth transition-colors"
                >
                  Continue
                </button>
              </form>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-2 bg-cream border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-olive focus:border-olive pr-10"
