          ...
          <div className="bg-page rounded-lg p-6 border border-main/20 opacity-95">
            <div className="mb-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <button className="bg-steel text-card rounded-full px-4 py-2 text-sm font-medium hover:bg-concrete transition-colors">
                  Edit
                </button>
              </div>
            </div>
            ...
            <div className="border-t border-main/20 pt-6">
              ...
              <div className="flex gap-3">
                <button className="flex-1 bg-steel text-card rounded-full px-4 py-2 text-sm font-medium hover:bg-concrete transition-colors">
                  Approve
                </button>
