...
export default function ApplicationFormsSection() {
  ...
  if (step === 'type') {
    return (
      <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-card border border-main/20 rounded-lg shadow-sm">
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-page rounded-lg p-6 border border-main/20 opacity-95">
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-card border border-main/20 rounded-lg shadow-sm">
      <div className="flex flex-col gap-8">
        ...
        <form onSubmit={handleSubmit} className="bg-page rounded-lg p-6 border border-main/20 opacity-95 space-y-6">
          <div>
