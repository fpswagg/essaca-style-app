      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button
              ...
              className="bg-page rounded-lg p-4 border border-main/20 hover:border-steel/30 hover:shadow-md transition-all text-left opacity-95"
            >
        ...
        {showConfirmDialog && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            ...
            <div className="relative bg-card rounded-2xl shadow-xl max-w-md w-full p-6 border border-main/20 max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 bg-transparent border-2 bg-steel text-steel rounded-full px-6 py-2 font-medium hover:bg-steel hover:text-card transition-colors"
                >
                  Cancel
                </button>
                <button
                  onClick={() => setShowConfirmDialog(false)}
                  className="flex-1 bg-red-600 text-card rounded-full px-6 py-2 font-medium hover:bg-red-700 transition-colors"
                >
                  Delete
                </button>
              </div>
            ...
            <div className="relative bg-card rounded-2xl shadow-xl max-w-md w-full p-6 border border-main/20 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="password"
                    className="w-full px-4 py-2 bg-card border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-steel"
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 bg-steel text-card rounded-full px-6 py-2 font-medium hover:bg-concrete transition-colors"
                  >
                    Create Account
                  </button>
                </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            ...
            <div className="relative bg-card rounded-2xl shadow-xl max-w-md w-full p-6 border border-main/20 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-main mb-2">
                    Application ID <span className="text-steel">*</span>
                  </label>
                  <select className="w-full px-4 py-2 bg-card border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-steel">
                ...
                <div>
                  <label className="block text-sm font-medium text-main mb-2">
                    Amount <span className="text-steel">*</span>
                  </label>
                  <input
                    type="number"
                    step="0.01"
                ...
                <div>
                  <label className="block text-sm font-medium text-main mb-2">
                    Status <span className="text-steel">*</span>
                  </label>
                  <select className="w-full px-4 py-2 bg-card border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-steel">
