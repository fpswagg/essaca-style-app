          ...
          <div className="bg-page rounded-none p-6 border-2 border-main/30">
            <div className="mb-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <button className="bg-steel text-card rounded-none px-4 py-2 text-sm font-medium hover:bg-concrete transition-colors">
                  Edit
                </button>
              </div>
            </div>
            ...
            <div className="border-t border-main/30 pt-6">
              ...
              <div className="flex gap-3">
                <button className="flex-1 bg-steel text-card rounded-none px-4 py-2 text-sm font-medium hover:bg-concrete transition-colors">
                  Approve
                </button>
