  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-card border-2 border-main/30 rounded-none shadow-md">
      <div className="flex flex-col gap-8">
        ...
        <div className="mt-4">
          <div className="max-w-md mx-auto bg-page rounded-none p-6 border-2 border-main/30">
            {step === 'email' ? (
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-2 bg-card border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-steel focus:border-steel pr-10"
