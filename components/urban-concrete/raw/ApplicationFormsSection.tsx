    ...
    return (
      <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-card border-2 border-main/30 rounded-none shadow-md">
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-page rounded-none p-6 border-2 border-main/30">
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-card border-2 border-main/30 rounded-none shadow-md">
      <div className="flex flex-col gap-8">
        ...
        <form onSubmit={handleSubmit} className="bg-page rounded-none p-6 border-2 border-main/30 space-y-6">
          <div>
            <h4 className="text-lg font-display font-light text-main mb-4 border-b border-main/30 pb-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-card border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-steel focus:border-steel"
                />
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-2 bg-card border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-steel focus:border-steel resize-y"
                />
