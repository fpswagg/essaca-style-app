      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button
              ...
              className="bg-page rounded-lg p-4 border border-main/10 hover:border-steel/30 hover:shadow-md transition-all text-left"
            >
        ...
        {showConfirmDialog && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            ...
            <div className="relative bg-card rounded-2xl shadow-xl max-w-md w-full p-6 border border-main/10">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 bg-transparent border-2 border-steel text-steel rounded-full px-6 py-2 font-medium hover:bg-steel hover:text-card transition-colors"
                >
                  Cancel
                </button>
                <button
        ...
        {showRegistrationDialog && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            ...
            <div className="relative bg-card rounded-2xl shadow-xl max-w-md w-full p-6 border border-main/10 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 bg-steel text-card rounded-full px-6 py-2 font-medium hover:bg-steel-alt transition-colors"
                  >
                    Create Account
                  </button>
                </div>
