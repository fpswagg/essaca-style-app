...
export default function ApplicationFormsSection() {
  ...
  if (step === 'type') {
    return (
      <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-card border border-main/10 rounded-xl shadow-sm">
          ...
          <div className="bg-page rounded-xl p-6 border border-main/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 bg-steel text-card rounded-full px-6 py-3 font-medium hover:bg-concrete transition-colors"
              >
                Yes, First Year
              </button>
              <button
                onClick={() => handleTypeSelection(false)}
                className="flex-1 bg-transparent border-2 bg-steel text-steel rounded-full px-6 py-3 font-medium hover:bg-steel hover:text-card transition-colors"
              >
                No, Not First Year
              </button>
            </div>
        ...
        <form onSubmit={handleSubmit} className="bg-page rounded-xl p-6 border border-main/10 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Last Name <span className="text-steel">*</span>
                </label>
                <input
                  type="text"
                  value={formData.lastName}
                  onChange={(e) => handleInputChange('lastName', e.target.value)}
                  className="w-full px-4 py-2 bg-card border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-steel focus:border-steel"
                />
                {errors.lastName && <p className="text-xs text-red-600 mt-1">{errors.lastName}</p>}
              </div>
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  First Name <span className="text-steel">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Mobile Phone <span className="text-steel">*</span>
                </label>
                <input
                  type="tel"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Date of Birth <span className="text-steel">*</span></label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Gender <span className="text-steel">*</span></label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Birth City <span className="text-steel">*</span></label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Nationality <span className="text-steel">*</span></label>
                <input
                  type="text"
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Last Class Attended <span className="text-steel">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Last School Attended <span className="text-steel">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Previous Diplomas <span className="text-steel">*</span>
                </label>
                <textarea
                  value={formData.previousDiplomas}
                  onChange={(e) => handleInputChange('previousDiplomas', e.target.value)}
                  rows={3}
                  className="w-full px-4 py-2 bg-card border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-steel focus:border-steel resize-y"
                />
