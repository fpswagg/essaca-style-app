...
export default function ApplicationFormsSection() {
  ...
  if (step === 'type') {
    return (
      <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-offwhite border border-main/20 rounded-none shadow-sm">
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-page rounded-none p-6 border border-main/20">
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-offwhite border border-main/20 rounded-none shadow-sm">
      <div className="flex flex-col gap-6">
        ...
        <form onSubmit={handleSubmit} className="bg-page rounded-none p-6 border border-main/20 space-y-6">
          <div>
