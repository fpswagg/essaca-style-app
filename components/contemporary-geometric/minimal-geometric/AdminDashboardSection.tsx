  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-offwhite border border-main/20 rounded-none shadow-sm">
      <div className="flex flex-col gap-6">
        <div>
          <h3 className="text-xl font-display font-light text-main mb-2">Admin Dashboard</h3>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3">
            {Object.entries(stats).map(([key, value]) => (
              <div key={key} className="bg-page rounded-none p-3 border border-main/20 text-center hover:border-magenta/40 transition-colors">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
            {managementLinks.map((link) => (
              <div
                key={link.name}
                className="bg-page rounded-none p-4 border border-main/20 hover:border-magenta/40 hover:shadow-md transition-all cursor-pointer"
              >
        ...
        <div>
          ...
          {applications.length === 0 ? (
            <div className="bg-page rounded-none p-8 border border-main/20 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
              {applications.map((app) => (
                <div
                  key={app.id}
                  className="bg-page rounded-none p-4 border border-main/20 hover:border-magenta/40 hover:shadow-md transition-all"
                >
                  ...
                  <button className="w-full bg-magenta text-offwhite rounded-none px-4 py-2 text-sm font-medium hover:bg-cyan transition-colors border border-magenta">
                    View Details
                  </button>
                </div>
              ))}
