          ...
          <div className="bg-page rounded-none p-6 border border-main/20">
            <div className="mb-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <button className="bg-magenta text-offwhite rounded-none px-4 py-2 text-sm font-medium hover:bg-cyan transition-colors">
                  Edit
                </button>
              </div>
            </div>
            ...
            <div className="border-t border-main/20 pt-6">
              ...
              <div className="flex gap-3">
                <button className="flex-1 bg-magenta text-offwhite rounded-none px-4 py-2 text-sm font-medium hover:bg-cyan transition-colors">
                  Approve
                </button>
