        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button
              ...
              className="bg-page rounded-2xl p-4 border border-main/10 hover:border-magenta/30 hover:shadow-md transition-all text-left bg-gradient-to-br from-page to-offwhite"
            >
