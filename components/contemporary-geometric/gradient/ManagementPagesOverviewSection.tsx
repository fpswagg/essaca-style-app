        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {managementPages.map((page) => (
              <div
                key={page.name}
                className="bg-page rounded-2xl p-5 border border-main/10 hover:border-magenta/30 hover:shadow-md transition-all bg-gradient-to-br from-page to-offwhite"
              >
