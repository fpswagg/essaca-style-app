  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-offwhite border border-main/10 rounded-2xl shadow-sm">
      <div className="flex flex-col gap-6">
        <div>
          <h3 className="text-xl font-display font-light bg-gradient-to-r from-magenta to-cyan bg-clip-text text-transparent mb-2">Client Dashboard</h3>
        ...
        {/* Application Card */}
        <div className="bg-gradient-to-br from-page to-offwhite rounded-2xl p-6 border border-main/10">
          <div className="mb-4">
          ...
          <button className="w-full bg-gradient-to-r from-magenta to-cyan text-offwhite rounded-full px-6 py-3 text-sm font-medium hover:from-cyan hover:to-magenta transition-all">
            View Details
          </button>
        </div>
      </div>
