  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-offwhite border border-main/10 rounded-2xl shadow-sm">
      <div className="flex flex-col gap-8">
        <div>
          <h3 className="text-xl font-display font-light bg-gradient-to-r from-magenta to-cyan bg-clip-text text-transparent mb-2">Staff Dashboard</h3>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {managementLinks.map((link) => (
              <div
                key={link.name}
                className="bg-gradient-to-br from-page to-offwhite rounded-xl p-4 border border-main/10 hover:border-magenta/30 hover:shadow-md transition-all cursor-pointer"
              >
        ...
        <div>
          ...
          {applications.length === 0 ? (
            <div className="bg-gradient-to-br from-page to-offwhite rounded-xl p-8 border border-main/10 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {applications.map((app) => (
                <div
                  key={app.id}
                  className="bg-gradient-to-br from-page to-offwhite rounded-xl p-4 border border-main/10 hover:border-magenta/30 hover:shadow-md transition-all"
                >
