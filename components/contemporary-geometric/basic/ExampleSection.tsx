...
export default function ExampleSection() {
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-offwhite border border-main/20 rounded-lg shadow-sm">
      <div className="flex flex-col gap-8">
        ...
        <div className="mt-4 p-4 bg-page rounded-lg border border-main/5">
