  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-offwhite border-2 border-magenta/40 rounded-lg shadow-lg">
      <div className="flex flex-col gap-8">
        <div>
          <h3 className="text-xl font-display font-light text-magenta mb-2">Staff Dashboard</h3>
        ...
        {/* Applications List */}
        <div>
          <h4 className="text-lg font-display font-light text-magenta mb-4">All Applications</h4>
