      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button
              ...
              className="bg-page rounded-lg p-4 border-2 border-magenta/40 hover:border-magenta/30 hover:shadow-md transition-all text-left"
            >
        ...
        {showConfirmDialog && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            ...
            <div className="relative bg-offwhite rounded-2xl shadow-xl max-w-md w-full p-6 border-2 border-magenta/40 max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 bg-transparent border-2 bg-magenta text-magenta rounded-full px-6 py-2 font-medium hover:bg-magenta hover:text-offwhite transition-colors"
                >
                  Cancel
                </button>
                <button
            ...
            <div className="relative bg-offwhite rounded-2xl shadow-xl max-w-md w-full p-6 border-2 border-magenta/40 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="password"
                    className="w-full px-4 py-2 bg-offwhite border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-magenta"
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 bg-magenta text-offwhite rounded-full px-6 py-2 font-medium hover:bg-cyan transition-colors"
                  >
                    Create Account
                  </button>
                </div>
            ...
            <div className="relative bg-offwhite rounded-2xl shadow-xl max-w-md w-full p-6 border-2 border-magenta/40 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <select className="w-full px-4 py-2 bg-offwhite border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-magenta">
