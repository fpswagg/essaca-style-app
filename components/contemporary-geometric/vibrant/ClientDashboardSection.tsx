  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-offwhite border-2 border-magenta/40 rounded-lg shadow-lg">
      <div className="flex flex-col gap-6">
        <div>
          <h3 className="text-xl font-display font-light text-magenta mb-2">Client Dashboard</h3>
        ...
        {/* Application Card */}
        <div className="bg-page rounded-lg p-6 border-2 border-magenta/40 shadow-md">
          <div className="mb-4">
            <h4 className="text-lg font-display font-light text-magenta mb-1">
          ...
          <button className="w-full bg-magenta text-offwhite rounded-full px-6 py-3 text-sm font-medium hover:bg-cyan transition-colors shadow-md">
            View Details
          </button>
        </div>
      </div>
