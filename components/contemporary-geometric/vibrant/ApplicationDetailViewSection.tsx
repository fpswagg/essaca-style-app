          ...
          <div className="bg-page rounded-lg p-6 border-2 border-magenta/40">
            <div className="mb-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <button className="bg-magenta text-offwhite rounded-full px-4 py-2 text-sm font-medium hover:bg-cyan transition-colors">
                  Edit
                </button>
              </div>
            </div>

            <div className="border-t border-magenta/40 pt-6 mb-6">
            ...
            <div className="border-t border-magenta/40 pt-6">
              ...
              <div className="flex gap-3">
                <button className="flex-1 bg-magenta text-offwhite rounded-full px-4 py-2 text-sm font-medium hover:bg-cyan transition-colors">
                  Approve
                </button>
