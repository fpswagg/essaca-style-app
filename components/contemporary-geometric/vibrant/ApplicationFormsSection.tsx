...
export default function ApplicationFormsSection() {
  ...
  if (step === 'type') {
    return (
      <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-offwhite border-2 border-magenta/40 rounded-lg shadow-lg">
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-page rounded-lg p-6 border-2 border-magenta/40">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 bg-magenta text-offwhite rounded-full px-6 py-3 font-medium hover:bg-cyan transition-colors"
              >
                Yes, First Year
              </button>
              <button
                onClick={() => handleTypeSelection(false)}
                className="flex-1 bg-transparent border-2 bg-magenta text-magenta rounded-full px-6 py-3 font-medium hover:bg-magenta hover:text-offwhite transition-colors"
              >
                No, Not First Year
              </button>
            </div>
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-offwhite border-2 border-magenta/40 rounded-lg shadow-lg">
      <div className="flex flex-col gap-8">
        ...
        <form onSubmit={handleSubmit} className="bg-page rounded-lg p-6 border-2 border-magenta/40 space-y-6">
          <div>
            <h4 className="text-lg font-display font-light text-main mb-4 border-b border-magenta/40 pb-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-offwhite border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-magenta focus:border-magenta"
                />
              ...
              <div className="sm:col-span-2">
                <label className="block text-sm font-medium text-main mb-2">
                  Address <span className="text-magenta">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Mobile Phone <span className="text-magenta">*</span>
                </label>
                <input
                  type="tel"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Date of Birth <span className="text-magenta">*</span></label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Gender <span className="text-magenta">*</span></label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Birth City <span className="text-magenta">*</span></label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Nationality <span className="text-magenta">*</span></label>
                <input
                  type="text"
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Last Class Attended <span className="text-magenta">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Last School Attended <span className="text-magenta">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Previous Diplomas <span className="text-magenta">*</span>
                </label>
                <textarea
                  value={formData.previousDiplomas}
                  onChange={(e) => handleInputChange('previousDiplomas', e.target.value)}
                  rows={3}
                  className="w-full px-4 py-2 bg-offwhite border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-magenta focus:border-magenta resize-y"
                />
