...
export default function AdminDashboardSection() {
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-parchment border border-main/10 rounded-lg shadow-sm">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
            {Object.entries(stats).map(([key, value]) => (
              <div key={key} className="bg-page rounded-lg p-4 border border-main/10 text-center hover:border-column/40 transition-colors">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {managementLinks.map((link) => (
              <div
                key={link.name}
                className="bg-page rounded-lg p-4 border border-main/10 hover:border-column/40 hover:shadow-md transition-all cursor-pointer"
              >
          ...
          {applications.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {applications.map((app) => (
                <div
                  key={app.id}
                  className="bg-page rounded-lg p-4 border border-main/10 hover:border-column/40 hover:shadow-md transition-all"
                >
                  ...
                  <button className="w-full bg-column text-parchment rounded-full px-4 py-2 text-sm font-medium hover:bg-main hover:text-parchment transition-colors">
                    View Details
                  </button>
                </div>
              ))}
