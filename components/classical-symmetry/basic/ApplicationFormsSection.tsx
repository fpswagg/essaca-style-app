          ...
          <div className="bg-page rounded-lg p-8 border border-main/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 bg-column text-marble rounded-full px-6 py-3 font-medium hover:bg-column-alt transition-colors"
              >
                Yes, First Year
              </button>
              <button
                onClick={() => handleTypeSelection(false)}
                className="flex-1 bg-transparent border-2 border-column text-column rounded-full px-6 py-3 font-medium hover:bg-column hover:text-marble transition-colors"
              >
                No, Not First Year
              </button>
            </div>
