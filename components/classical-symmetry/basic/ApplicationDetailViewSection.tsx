          ...
          <div className="bg-page rounded-lg p-6 border border-main/10">
            <div className="mb-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <button className="bg-column text-marble rounded-full px-4 py-2 text-sm font-medium hover:bg-column-alt transition-colors">
                  Edit
                </button>
              </div>
            </div>
            ...
            <div className="border-t border-main/20 pt-6">
              ...
              <div className="flex gap-3">
                <button className="flex-1 bg-column text-marble rounded-full px-6 py-2 font-medium hover:bg-column-alt transition-colors">
                  Approve
                </button>
                <button className="flex-1 bg-transparent border-2 border-red-600 text-red-600 rounded-full px-6 py-2 font-medium hover:bg-red-600 hover:text-marble transition-colors">
                  Reject
                </button>
              </div>
            </div>
