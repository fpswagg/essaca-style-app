...
export default function ApplicationFormsSection() {
  ...
  if (step === 'type') {
    return (
      <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-marble border border-main/10 rounded-xl shadow-sm">
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-page rounded-xl p-6 border border-main/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 bg-column text-marble rounded-full px-6 py-3 font-medium hover:bg-main transition-colors"
              >
                Yes, First Year
              </button>
              <button
                onClick={() => handleTypeSelection(false)}
                className="flex-1 bg-transparent border-2 bg-column text-column rounded-full px-6 py-3 font-medium hover:bg-column hover:text-marble transition-colors"
              >
                No, Not First Year
              </button>
            </div>
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-marble border border-main/10 rounded-xl shadow-sm">
      <div className="flex flex-col gap-8">
        ...
        <form onSubmit={handleSubmit} className="bg-page rounded-xl p-6 border border-main/10 space-y-6">
          <div>
            <h4 className="text-lg font-display font-light text-main mb-4 border-b border-main/10 pb-2">
              CANDIDAT (Candidate Information)
            </h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Last Name <span className="text-column">*</span>
                </label>
                <input
                  type="text"
                  value={formData.lastName}
                  onChange={(e) => handleInputChange('lastName', e.target.value)}
                  className="w-full px-4 py-2 bg-marble border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-column focus:border-column"
                />
                {errors.lastName && <p className="text-xs text-red-600 mt-1">{errors.lastName}</p>}
              </div>
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  First Name <span className="text-column">*</span>
                </label>
                <input
                  type="text"
              ...
              <div className="sm:col-span-2">
                <label className="block text-sm font-medium text-main mb-2">
                  Address <span className="text-column">*</span>
                </label>
                <input
                  type="text"
              ...
              <div className="sm:col-span-2">
                <label className="block text-sm font-medium text-main mb-2">
                  Email <span className="text-column">*</span>
                </label>
                <input
                  type="email"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Mobile Phone <span className="text-column">*</span>
                </label>
                <input
                  type="tel"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Date of Birth <span className="text-column">*</span></label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Gender <span className="text-column">*</span></label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Birth City <span className="text-column">*</span></label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Nationality <span className="text-column">*</span></label>
                <input
                  type="text"
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Last Class Attended <span className="text-column">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Last School Attended <span className="text-column">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Previous Diplomas <span className="text-column">*</span>
                </label>
                <textarea
                  value={formData.previousDiplomas}
                  onChange={(e) => handleInputChange('previousDiplomas', e.target.value)}
                  rows={3}
                  className="w-full px-4 py-2 bg-marble border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-column focus:border-column resize-y"
                />
