        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button
              ...
              className="bg-page rounded-xl p-4 border border-main/10 hover:border-column/30 hover:shadow-md transition-all text-left"
            >
            ...
            <div className="relative bg-marble rounded-2xl shadow-xl max-w-md w-full p-6 border border-main/10 max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 bg-transparent border-2 bg-column text-column rounded-full px-6 py-2 font-medium hover:bg-column hover:text-marble transition-colors"
                >
                  Cancel
                </button>
                <button
            ...
            <div className="relative bg-marble rounded-2xl shadow-xl max-w-md w-full p-6 border border-main/10 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 bg-column text-marble rounded-full px-6 py-2 font-medium hover:bg-main transition-colors"
                  >
                    Create Account
                  </button>
                </div>
