  ...
  return (
    <section className="max-w-4xl mx-auto p-8 sm:p-10 bg-cta border border-main/10 rounded-lg shadow-sm">
      <div className="flex flex-col gap-10">
        ...
        {/* Statistics Section */}
        <div>
          <h4 className="text-lg font-display font-light text-main mb-5">Statistics</h4>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-5">
            {Object.entries(stats).map(([key, value]) => (
              <div key={key} className="bg-page rounded-lg p-5 border border-main/10 text-center hover:border-burgundy/30 transition-colors">
        ...
        <div>
          <h4 className="text-lg font-display font-light text-main mb-5">Applications Overview</h4>
