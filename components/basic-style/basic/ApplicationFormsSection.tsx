...
export default function ApplicationFormsSection() {
  ...
  if (step === 'type') {
    return (
      <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-cta border border-main/10 rounded-lg shadow-sm">
          ...
          <div className="bg-page rounded-lg p-8 border border-main/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 bg-burgundy text-cta rounded-full px-6 py-3 font-medium hover:bg-burgundy-alt transition-colors"
              >
                Yes, First Year
              </button>
              <button
                onClick={() => handleTypeSelection(false)}
                className="flex-1 bg-transparent border-2 border-burgundy text-burgundy rounded-full px-6 py-3 font-medium hover:bg-burgundy hover:text-cta transition-colors"
              >
                No, Not First Year
              </button>
            </div>
        ...
        <form onSubmit={handleSubmit} className="bg-page rounded-lg p-6 border border-main/10 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-cta border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-burgundy focus:border-burgundy"
                />
              ...
              <div className="sm:col-span-2">
                <label className="block text-sm font-medium text-main mb-2">
                  Address <span className="text-burgundy">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Date of Birth <span className="text-burgundy">*</span></label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Gender <span className="text-burgundy">*</span></label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Birth City <span className="text-burgundy">*</span></label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Nationality <span className="text-burgundy">*</span></label>
                <input
                  type="text"
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Last Class Attended <span className="text-burgundy">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Last School Attended <span className="text-burgundy">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">
                  Previous Diplomas <span className="text-burgundy">*</span>
                </label>
                <textarea
                  value={formData.previousDiplomas}
                  onChange={(e) => handleInputChange('previousDiplomas', e.target.value)}
                  rows={3}
                  className="w-full px-4 py-2 bg-cta border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-burgundy focus:border-burgundy resize-y"
                />
