      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button
              ...
              className="bg-page rounded-lg p-4 border border-main/10 hover:border-burgundy/30 hover:shadow-md transition-all text-left"
            >
        ...
        {showConfirmDialog && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            ...
            <div className="relative bg-cta rounded-2xl shadow-xl max-w-md w-full p-6 border border-main/10">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 bg-transparent border-2 border-burgundy text-burgundy rounded-full px-6 py-2 font-medium hover:bg-burgundy hover:text-cta transition-colors"
                >
                  Cancel
                </button>
                <button
                  onClick={() => setShowConfirmDialog(false)}
                  className="flex-1 bg-red-600 text-cta rounded-full px-6 py-2 font-medium hover:bg-red-700 transition-colors"
                >
                  Delete
                </button>
              </div>
        ...
        {showRegistrationDialog && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            ...
            <div className="relative bg-cta rounded-2xl shadow-xl max-w-md w-full p-6 border border-main/10 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="password"
                    className="w-full px-4 py-2 bg-cta border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-burgundy"
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 bg-burgundy text-cta rounded-full px-6 py-2 font-medium hover:bg-burgundy-alt transition-colors"
                  >
                    Create Account
                  </button>
                </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            ...
            <div className="relative bg-cta rounded-2xl shadow-xl max-w-md w-full p-6 border border-main/10 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-main mb-2">
                    Application ID <span className="text-burgundy">*</span>
                  </label>
                  <select className="w-full px-4 py-2 bg-cta border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-burgundy">
                ...
                <div>
                  <label className="block text-sm font-medium text-main mb-2">
                    Status <span className="text-burgundy">*</span>
                  </label>
                  <select className="w-full px-4 py-2 bg-cta border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-burgundy">
