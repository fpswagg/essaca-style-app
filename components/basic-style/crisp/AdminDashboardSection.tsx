...
export default function AdminDashboardSection() {
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-cta border-2 border-main/20 rounded-lg shadow-sm">
      <div className="flex flex-col gap-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3">
            {Object.entries(stats).map(([key, value]) => (
              <div key={key} className="bg-page rounded-md p-3 border-2 border-main/20 text-center hover:border-burgundy/50 transition-colors">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
            {managementLinks.map((link) => (
              <div
                key={link.name}
                className="bg-page rounded-md p-4 border-2 border-main/20 hover:border-burgundy/50 hover:shadow-md transition-all cursor-pointer"
              >
        ...
        <div>
          ...
          {applications.length === 0 ? (
            <div className="bg-page rounded-md p-8 border-2 border-main/20 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
              {applications.map((app) => (
                <div
                  key={app.id}
                  className="bg-page rounded-md p-4 border-2 border-main/20 hover:border-burgundy/50 hover:shadow-md transition-all"
                >
