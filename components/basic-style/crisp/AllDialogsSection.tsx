      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button
              ...
              className="bg-page rounded-md p-4 border-2 border-main/20 hover:border-burgundy/30 hover:shadow-md transition-all text-left"
            >
        ...
        {showConfirmDialog && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            ...
            <div className="relative bg-cta rounded-2xl shadow-xl max-w-md w-full p-6 border-2 border-main/20 max-h-[90vh] overflow-y-auto">
            ...
            <div className="relative bg-cta rounded-2xl shadow-xl max-w-md w-full p-6 border-2 border-main/20 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="password"
                    className="w-full px-4 py-2 bg-cta border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-burgundy"
            ...
            <div className="relative bg-cta rounded-2xl shadow-xl max-w-md w-full p-6 border-2 border-main/20 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <select className="w-full px-4 py-2 bg-cta border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-burgundy">
