          ...
          <div className="bg-page rounded-2xl p-6 border border-main/10">
            <div className="mb-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <button className="bg-burgundy text-cta rounded-full px-4 py-2 text-sm font-medium hover:bg-burgundy-alt transition-colors">
                  Edit
                </button>
              </div>
            </div>

            <div className="border-t border-main/10 pt-6 mb-6">
            ...
            <div className="border-t border-main/10 pt-6">
              ...
              <div className="flex gap-3">
                <button className="flex-1 bg-burgundy text-cta rounded-full px-4 py-2 text-sm font-medium hover:bg-burgundy-alt transition-colors">
                  Approve
                </button>
