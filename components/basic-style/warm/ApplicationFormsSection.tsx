...
export default function ApplicationFormsSection() {
  ...
  if (step === 'type') {
    return (
      <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-cta border border-main/10 rounded-2xl shadow-sm">
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-page rounded-2xl p-6 border border-main/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                ...
                className="flex-1 bg-transparent border-2 bg-burgundy text-burgundy rounded-full px-6 py-3 font-medium hover:bg-burgundy hover:text-cta transition-colors"
              >
                No, Not First Year
              </button>
            </div>
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-cta border border-main/10 rounded-2xl shadow-sm">
      <div className="flex flex-col gap-6">
        ...
        <form onSubmit={handleSubmit} className="bg-page rounded-2xl p-6 border border-main/10 space-y-6">
          <div>
