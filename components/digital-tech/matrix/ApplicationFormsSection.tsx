    ...
    return (
      <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-panel border border-neon/50 rounded-none shadow-sm">
        <div className="flex flex-col gap-8">
          <div>
            <h3 className="text-xl font-display font-light text-main mb-2 font-mono">Application Forms</h3>
          ...
          <div className="bg-page rounded-none p-6 border border-neon/50">
            <h4 className="text-lg font-display font-light text-main mb-4 font-mono">Are you applying for first year?</h4>
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                onClick={() => handleTypeSelection(true)}
                className="flex-1 bg-neon text-page rounded-full px-6 py-3 font-medium hover:bg-electric transition-colors"
              >
                Yes, First Year
              </button>
              <button
                onClick={() => handleTypeSelection(false)}
                className="flex-1 bg-transparent border-2 bg-neon text-neon rounded-full px-6 py-3 font-medium hover:bg-neon hover:text-page transition-colors"
              >
                No, Not First Year
              </button>
            </div>
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-panel border border-neon/50 rounded-none shadow-sm">
      <div className="flex flex-col gap-8">
        ...
        <form onSubmit={handleSubmit} className="bg-page rounded-none p-6 border border-neon/50 space-y-6">
          <div>
            <h4 className="text-lg font-display font-light text-main mb-4 border-b border-neon/50 pb-2 font-mono">
              CANDIDAT (Candidate Information)
            </h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-main mb-2 font-mono">
                  Last Name <span className="text-neon">*</span>
                </label>
                <input
                  type="text"
                  value={formData.lastName}
                  onChange={(e) => handleInputChange('lastName', e.target.value)}
                  className="w-full px-4 py-2 bg-panel border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-neon focus:border-neon font-mono"
                />
                {errors.lastName && <p className="text-xs text-red-600 mt-1">{errors.lastName}</p>}
              </div>
              <div>
                <label className="block text-sm font-medium text-main mb-2 font-mono">
                  First Name <span className="text-neon">*</span>
                </label>
                <input
                  type="text"
              ...
              <div className="sm:col-span-2">
                <label className="block text-sm font-medium text-main mb-2 font-mono">
                  Address <span className="text-neon">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2 font-mono">
                  Mobile Phone <span className="text-neon">*</span>
                </label>
                <input
                  type="tel"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2 font-mono">Date of Birth <span className="text-neon">*</span></label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2 font-mono">Gender <span className="text-neon">*</span></label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2 font-mono">Birth City <span className="text-neon">*</span></label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2 font-mono">Nationality <span className="text-neon">*</span></label>
                <input
                  type="text"
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-main mb-2 font-mono">
                  Last Class Attended <span className="text-neon">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2 font-mono">
                  Last School Attended <span className="text-neon">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2 font-mono">
                  Previous Diplomas <span className="text-neon">*</span>
                </label>
                <textarea
                  value={formData.previousDiplomas}
                  onChange={(e) => handleInputChange('previousDiplomas', e.target.value)}
                  rows={3}
                  className="w-full px-4 py-2 bg-panel border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-neon focus:border-neon resize-y font-mono"
                />
