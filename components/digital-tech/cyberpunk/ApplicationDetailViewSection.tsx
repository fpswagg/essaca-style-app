  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-panel border-2 border-neon/30 rounded-lg shadow-lg">
      <div className="flex flex-col gap-8">
        <div>
          <h3 className="text-xl font-display font-light text-main mb-2 drop-shadow-[0_0_8px_rgba(0,255,136,0.5)]">ApplicationDetailView</h3>
          ...
          <div className="bg-page rounded-lg p-6 border-2 border-neon/30">
            <div className="mb-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <button className="bg-neon text-page rounded-full px-4 py-2 text-sm font-medium hover:bg-electric transition-colors shadow-[0_0_12px_rgba(0,255,136,0.6)]">
                  Edit
                </button>
              </div>
            </div>

            <div className="border-t border-neon/30 pt-6 mb-6">
            ...
            <div className="border-t border-neon/30 pt-6">
              ...
              <div className="flex gap-3">
                <button className="flex-1 bg-neon text-page rounded-full px-4 py-2 text-sm font-medium hover:bg-electric transition-colors shadow-[0_0_12px_rgba(0,255,136,0.6)]">
                  Approve
                </button>
