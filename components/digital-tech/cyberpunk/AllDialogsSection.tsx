  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-panel border-2 border-neon/30 rounded-lg shadow-lg">
      <div className="flex flex-col gap-8">
        <div>
          <h3 className="text-xl font-display font-light text-main mb-2 drop-shadow-[0_0_8px_rgba(0,255,136,0.5)]">AllDialogs</h3>
        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button
              ...
              className="bg-page rounded-lg p-4 border-2 border-neon/30 hover:border-neon/30 hover:shadow-md transition-all text-left"
            >
        ...
        {showConfirmDialog && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            ...
            <div className="relative bg-panel rounded-2xl shadow-xl max-w-md w-full p-6 border-2 border-neon/30 max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 bg-transparent border-2 bg-neon text-neon rounded-full px-6 py-2 font-medium hover:bg-neon hover:text-page transition-colors"
                >
                  Cancel
                </button>
                <button
                  onClick={() => setShowConfirmDialog(false)}
                  className="flex-1 bg-red-600 text-page rounded-full px-6 py-2 font-medium hover:bg-red-700 transition-colors"
                >
                  Delete
                </button>
              </div>
            ...
            <div className="relative bg-panel rounded-2xl shadow-xl max-w-md w-full p-6 border-2 border-neon/30 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="password"
                    className="w-full px-4 py-2 bg-panel border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-neon"
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 bg-neon text-page rounded-full px-6 py-2 font-medium hover:bg-electric transition-colors shadow-[0_0_12px_rgba(0,255,136,0.6)]"
                  >
                    Create Account
                  </button>
                </div>
            ...
            <div className="relative bg-panel rounded-2xl shadow-xl max-w-md w-full p-6 border-2 border-neon/30 max-h-[90vh] overflow-y-auto">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <select className="w-full px-4 py-2 bg-panel border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-neon">
