    ...
    return (
      <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-panel border-2 border-neon/30 rounded-lg shadow-lg">
        <div className="flex flex-col gap-8">
          <div>
            <h3 className="text-xl font-display font-light text-main mb-2 drop-shadow-[0_0_8px_rgba(0,255,136,0.5)]">Application Forms</h3>
          ...
          <div className="bg-page rounded-lg p-6 border-2 border-neon/30">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 bg-neon text-page rounded-full px-6 py-3 font-medium hover:bg-electric transition-colors shadow-[0_0_12px_rgba(0,255,136,0.6)]"
              >
                Yes, First Year
              </button>
              <button
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-panel border-2 border-neon/30 rounded-lg shadow-lg">
      <div className="flex flex-col gap-8">
        ...
        <form onSubmit={handleSubmit} className="bg-page rounded-lg p-6 border-2 border-neon/30 space-y-6">
          <div>
            <h4 className="text-lg font-display font-light text-main mb-4 border-b border-neon/30 pb-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-panel border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-neon focus:border-neon"
                />
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Date of Birth <span className="text-neon">*</span></label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Gender <span className="text-neon">*</span></label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Birth City <span className="text-neon">*</span></label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-main mb-2">Nationality <span className="text-neon">*</span></label>
                <input
                  type="text"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-2 bg-panel border-2 border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-neon focus:border-neon resize-y"
                />
