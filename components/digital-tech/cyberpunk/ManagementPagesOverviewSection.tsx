  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-panel border-2 border-neon/30 rounded-lg shadow-lg">
      <div className="flex flex-col gap-8">
        <div>
          <h3 className="text-xl font-display font-light text-main mb-2 drop-shadow-[0_0_8px_rgba(0,255,136,0.5)]">ManagementPagesOverview</h3>
        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {managementPages.map((page) => (
              <div
                key={page.name}
                className="bg-page rounded-lg p-5 border-2 border-neon/30 hover:border-neon/30 hover:shadow-md transition-all"
              >
