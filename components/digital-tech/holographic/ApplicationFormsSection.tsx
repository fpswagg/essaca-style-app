...
export default function ApplicationFormsSection() {
  ...
  if (step === 'type') {
    return (
      <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-panel border border-neon/30 rounded-2xl shadow-sm backdrop-blur-sm">
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-page rounded-2xl p-6 border border-neon/30 backdrop-blur-sm">
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-panel border border-neon/30 rounded-2xl shadow-sm backdrop-blur-sm">
      <div className="flex flex-col gap-8">
        ...
        <form onSubmit={handleSubmit} className="bg-page rounded-2xl p-6 border border-neon/30 backdrop-blur-sm space-y-6">
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-panel border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-neon focus:border-neon"
                />
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-2 bg-panel border border-main/20 rounded-md text-main focus:outline-none focus:ring-2 focus:ring-neon focus:border-neon resize-y"
                />
