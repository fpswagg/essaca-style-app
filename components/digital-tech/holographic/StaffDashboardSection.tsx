  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-panel/80 backdrop-blur-sm border border-neon/30 rounded-2xl shadow-lg">
      <div className="flex flex-col gap-8">
        <div>
          <h3 className="text-xl font-display font-light text-neon mb-2 drop-shadow-[0_0_6px_rgba(0,255,136,0.3)]">Staff Dashboard</h3>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {managementLinks.map((link) => (
              <div
                key={link.name}
                className="bg-page/50 backdrop-blur-sm rounded-xl p-4 border border-neon/30 hover:border-neon/60 hover:shadow-md transition-all cursor-pointer shadow-md"
              >
        ...
        {/* Applications List */}
        <div>
          <h4 className="text-lg font-display font-light text-neon mb-4 drop-shadow-[0_0_4px_rgba(0,255,136,0.3)]">All Applications</h4>
          {applications.length === 0 ? (
            <div className="bg-page/50 backdrop-blur-sm rounded-xl p-8 border border-neon/30 text-center shadow-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {applications.map((app) => (
                <div
                  key={app.id}
                  className="bg-page/50 backdrop-blur-sm rounded-xl p-4 border border-neon/30 hover:border-neon/60 hover:shadow-md transition-all shadow-md"
                >
