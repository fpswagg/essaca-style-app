      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button
              ...
              className="bg-page rounded-2xl p-4 border border-neon/30 hover:border-neon/30 hover:shadow-md transition-all text-left backdrop-blur-sm"
            >
        ...
        {showConfirmDialog && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            ...
            <div className="relative bg-panel rounded-2xl shadow-xl max-w-md w-full p-6 border border-neon/30 max-h-[90vh] overflow-y-auto backdrop-blur-sm">
