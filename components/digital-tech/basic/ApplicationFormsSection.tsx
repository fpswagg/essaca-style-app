...
export default function ApplicationFormsSection() {
  ...
  const handleTypeSelection = (firstYear: boolean) => {
    ...
    if (firstYear) {
      ...
      // In real app, redirect to instructions
  ...
  if (step === 'type') {
    return (
      <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-panel border border-main/10 rounded-lg shadow-sm">
          ...
          <div className="bg-page rounded-lg p-8 border border-main/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                ...
                className="flex-1 bg-transparent border-2 border-neon text-neon rounded-full px-6 py-3 font-medium hover:bg-neon hover:text-page transition-colors"
              >
                No, Not First Year
              </button>
            </div>
  ...
  return (
    <section className="max-w-4xl mx-auto p-6 sm:p-8 bg-panel border border-main/10 rounded-lg shadow-sm">
      <div className="flex flex-col gap-6">
        ...
        <form onSubmit={handleSubmit} className="bg-page rounded-lg p-6 border border-main/10 space-y-6">
          {/* CANDIDAT Section */}
          <div>
